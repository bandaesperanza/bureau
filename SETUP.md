...
2. Build > Authentication → activer le fournisseur **Email/mot de passe**
...
3. API et services > Écran de consentement OAuth :
   - Type : Externe
   - Renseigner nom de l'app, email de contact
   - Champs d'application : ajouter `.../auth/drive.file`
   - Utilisateurs test : ajouter les emails des personnes autorisées à saisir
     (tant que l'app reste en mode "Test", non vérifiée par Google)
